...
public class Partie {
    ...
    /**
     * constructeur : génère une grille vide et initialise les coups de l'utilisateur à 0
    ...
    public void lancerPartie(){
        ...
        while (!grille.cellulesToutesEteintes()){
            ...
            else if (coup == 'Y') grille.activerDiagonaleDescendante();
            else if (coup =='Z') grille.activerDiagonaleMontante();
            else{
